 ...
 */
public class ButtonTableCell3Actions<T> extends TableCell<T, T> {
     ...
     * @param buttonThree
     */
    public ButtonTableCell3Actions(EventHandler<ActionEvent> buttonOne, EventHandler<ActionEvent> buttonTwo, EventHandler<ActionEvent> buttonThree){
